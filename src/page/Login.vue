        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="https://static.vecteezy.com/system/resources/previews/001/991/652/original/sign-in-page-flat-design-concept-illustration-icon-account-login-user-login-abstract-metaphor-can-use-for-landing-page-mobile-app-ui-posters-banners-free-vector.jpg"
                   alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;"/>
            </div>
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">

                <form action="#" @submit.prevent @submit="login">
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Войти в аккаунт</h5>

                  <div class="form-outline mb-4">
                    <label class="form-label" for="form2Example17">Почта</label>
                    <input v-model="auth.email" type="email" name="email" id="form2Example17" :class="`form-control form-control-lg ${getFieldError('email')}`"/>
